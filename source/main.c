...
int movexball_tick(int bxstate){
	switch(bxstate){
		...
		//	pattern[1]=pattern[0];
		/*        if(ballx==2){pattern[1]=0x02;}
			else if(ballx==3){pattern[1]=0x04;}
			else if(ballx==4){pattern[1]=0x08;}
			else if(ballx==5){pattern[1]=0x10;}
			else if(ballx==6){pattern[1]=0x20;}
			else if(ballx==7){pattern[1]=0x40;}
			}
			else if(ballx==(paddlecenterx+1)){}*/
			break;
